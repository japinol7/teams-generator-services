...
CONFIG_VARS = {
    ...
    'teams_gen_file_contestants': ConfigVars(
        'TEAMS_GEN_FILE_CONTESTANTS', 'teams-gen-file-contestants'
    ),
    'teams_gen_file_contestants_orig': ConfigVars(
        'TEAMS_GEN_FILE_CONTESTANTS_ORIG', 'teams-gen-file-contestants-orig'
    ),
}
